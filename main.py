...
class MenuScreen(Frame, Canvas):
    def __init__(self, container):
        ...
        self.play = False
        self.music = True
        self.commands=[lambda: Simon.in_simon(),lambda: pong.in_pong(True),lambda: pong.in_pong(False),lambda: speed.in_speed()]
        self.button = 0
        self.button0 = None
        self.button1 = None
        self.button2 = None
    ...
    def menuSet(self):
        ...
        self.button0 = Button(self, text = "Start", font = ('ARCADECLASSIC', 15), height = 2, width = 15, anchor = 'center', bg = 'white', command = lambda: Simon.in_simon())
        ...
        self.button3 = Button(self, text = "Start", font = ('ARCADECLASSIC', 15), height = 2, width = 15, anchor = 'center', bg = 'white', command = lambda: speed.in_speed())
